...
const WRAM_0_SIZE: usize = ((WRAM_0_END - WRAM_0_START) + 1) as usize;
...
impl<'a> MemoryBus {
    ...
    pub fn read_byte(&self, address: u16) -> u8 {
        ...
        match address {
            ...
            IO_REGISTERS_START..=IO_REGISTERS_END => self.io_registers[(address - IO_REGISTERS_START) as usize],
            HRAM_START..=HRAM_END => self.hram[(address - HRAM_START) as usize],
            INTERRUPT_ENABLE_REGISTER => { unimplemented!("Interupt enable register in memory bus") }
            _ => {panic!("Unimplemented read_byte in memory bus")}
        }
    }
    pub fn write_byte(&mut self, address: u16, value: u8) {
        ...
        match address {
            ...
            EXTERNAL_RAM_START..=EXTERNAL_RAM_END => self.external_ram[(address - EXTERNAL_RAM_START) as usize] = value,
            ...
            ECHO_RAM_START..=ECHO_RAM_END => self.echo_ram[(address - ECHO_RAM_START) as usize] = value,
            ...
            IO_REGISTERS_START..=IO_REGISTERS_END => self.io_registers[(address - IO_REGISTERS_START) as usize] = value,
            ...
            _ => {panic!("Unimplemented write_byte in memory bus")}
        }
    }
    ...
    pub fn read_short(&mut self, address: u16) -> u16 {
        match address {
            ...
            0x8000..=0x9FFF => unimplemented!("VRAM read"),
